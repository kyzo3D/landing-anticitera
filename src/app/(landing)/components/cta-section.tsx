...
function Card(card: { icon: JSX.Element; bg: JSX.Element }) {
  ...
  return (
    <motion.div
      ...
      initial={{ opacity: 0 }}
      animate={controls}
      className='relative size-20 transform-gpu cursor-pointer overflow-hidden rounded-2xl border p-4 [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]'
    >
      {card.icon}
      {card.bg}
    </motion.div>
        ...
        <div className='flex w-full flex-col items-center justify-center'>
          <div className='relative flex w-full flex-col items-center justify-center overflow-hidden'>
            ...
            <div className='absolute z-10'>
              <div className='mx-auto size-24 rounded-[2rem] border bg-background/10 p-3 shadow-2xl backdrop-blur-md lg:size-32'>
                <HeartHandshake className='mx-auto size-16 text-foreground lg:size-24' />
              </div>
              <div className='z-10 mt-4 flex flex-col items-center text-center text-foreground'>
                <h1 className='text-3xl font-bold lg:text-4xl'>
                  Improve the productivity of your team
                </h1>
                <p className='mt-2'>
                  Try out our autonomous agents for free. No credit card
                  required.
                </p>
                <Link
